import "../App.css"
import Festivalsimg from "../assets/images/3.jpg";
import Tourismimg from "../assets/images/4.jpg";
const Kerala = ()=>{
...
export const Festivals= ()=>{
    ...
    return(
        ...
        <div className="festivals">
            <div>
                <img src={Festivalsimg} alt="" />
                <h2> FESTIVALS IN KERALA</h2></div>
            <div>
...
export const Tourism = ()=>{
    ...
    return(
        ...
        <div className="tourism">
            <div>
                <img src={Tourismimg} alt="" />
                <h2>TOURISM IN KERALA</h2></div>
            <div>
